...
public class NavigationViewController: NavigationPulleyViewController, RouteMapViewControllerDelegate {
    ...
    */
    ...
    var customMarker: MGLPointAnnotation?
    ...
    public override func viewWillAppear(_ animated: Bool) {
        ...
        if simulatesLocationUpdates {
            ...
            simulation?.start()
            if(customMarker == nil) {
                print("aggiungo il marker")
                customMarker = MGLPointAnnotation()
                customMarker?.coordinate = CLLocationCoordinate2D(latitude: 37.343, longitude:  -122.0320358690685)
