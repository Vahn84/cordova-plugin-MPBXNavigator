...
if (process.env.TARGET) {
  ...
  // Add java files where you want to add R.java imports in the following array
    ...
    var filestoreplace = [
        "platforms/android/src/com/vahn/cordova/mpbxnavigator/NavigationActivity.java"
    ];
    filestoreplace.forEach(function(val, index, array) {
        if (fs.existsSync(val)) {
          ...
          var packageName = configobj.installed_plugins["cordova-plugin-mpbxnavigator"]["PACKAGE_NAME"];
          console.log("With the package name: "+packageName);
          console.log("Adding import for R.java");
            replace_string_in_file(val,"package com.vahn.cordova.mpbxnavigator;","package com.vahn.cordova.mpbxnavigator;\n\nimport "+packageName+".R;");
